                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav mega-nav pr-2 mr-2 pl-2 d-none d-xl-block "><!--web-->
                        <li class="nav-item {{!request()->is('/')?'dropdown':''}}">
                            ...
                            @if(request()->is('/'))
                                <ul class="dropdown-menu"
                                    style="display: block!important;margin-top: 7px; box-shadow: none;min-width: 303px !important;margin-left: 1px!important;padding-bottom: 0px!important;z-index: 1;">
