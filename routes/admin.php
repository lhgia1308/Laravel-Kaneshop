    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'web-config', 'as' => 'web-config.','middleware'=>['module:web_&_app_settings']], function () {
                ...
                Route::post('generate_seed_files', 'BusinessSettingsController@generate_seed_files')->name('generate_seed_files');
                Route::post('generate_migration_files', 'BusinessSettingsController@generate_migration_files')->name('generate_migration_files');
